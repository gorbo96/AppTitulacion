...
/***/ 10836:
/*!**********************************!*\
  !*** ./src/app/domain/family.ts ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Familia": () => (/* binding */ Familia)
/* harmony export */ });
class Familia {
}
...
/***/ 30197:
/*!***************************************!*\
  !*** ./src/app/domain/presupuesto.ts ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Presupuesto": () => (/* binding */ Presupuesto)
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PresupuestosService": () => (/* binding */ PresupuestosService)
/* harmony export */ });
...
let PresupuestosService = class PresupuestosService {
    ...
    obtenerPresupuestoCtgr(idC, idF) {
        //Consultar en la coleccion presupuestos todos los valores correspondientes a una familia y una categoria
        return this.afs.collection("presupuestos", ref => ref.where("id_familia", "==", idF).where("id_categoria", "==", idC)).valueChanges();
    }
    obtenerPresupuestoFml(idF) {
        //Consultar en la coleccion families todos los valores correspondientes a un identificador
        return this.afs.collection("families", ref => ref.where("id_familia", "==", idF)).valueChanges();
    }
    obtenerPresupuestos(idF) {
        //Consultar en la coleccion presupuestos activos todos los valores correspondientes a una familia 
        return this.afs.collection("presupuestos", ref => ref.where("id_familia", "==", idF)).valueChanges();
    }
    obtenerFamilia(idF) {
        //Consultar en la coleccion families todos los valores correspondientes a un identificador
        return this.afs.collection("families", ref => ref.where("id", "==", idF)).valueChanges();
    }
    actualizarPresupuesto(presupuesto) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
            ...
            return yield this.afs.collection("presupuestos").doc(presupuesto.id).update({
                cantidad: presupuesto.cantidad,
                fecha: presupuesto.fecha
            });
        });
    }
    actualizarFamiliaPrsp(familia, monto) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__awaiter)(this, void 0, void 0, function* () {
            //Funcion para actulizar el registro del presupuesto general en un documento de la coleccion familia
            return yield this.afs.collection("families").doc(familia).update({ presupuesto_global: monto });
        });
    }
};
...
PresupuestosService = (0,tslib__WEBPACK_IMPORTED_MODULE_0__.__decorate)([
...
/* harmony export */ });
/* harmony import */ var C_Users_bmgpc_Documents_titulacion_AppTitulacion_gestionar_gastos_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./node_modules/@babel/runtime/helpers/esm/asyncToGenerator.js */ 71670);
...
const attachComponent = /*#__PURE__*/function () {
  var _ref = (0,C_Users_bmgpc_Documents_titulacion_AppTitulacion_gestionar_gastos_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (delegate, container, component, cssClasses, componentProps, inline) {
    var _a;
...
const CoreDelegate = () => {
  ...
  const attachViewToDom = /*#__PURE__*/function () {
    var _ref2 = (0,C_Users_bmgpc_Documents_titulacion_AppTitulacion_gestionar_gastos_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (parentElement, userComponent, userComponentProps = {}, cssClasses = []) {
      var _a, _b;
...
const getScrollElement = /*#__PURE__*/function () {
  var _ref = (0,C_Users_bmgpc_Documents_titulacion_AppTitulacion_gestionar_gastos_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (el) {
    if (isIonContent(el)) {
      yield new Promise(resolve => (0,_helpers_1ec1a6dd_js__WEBPACK_IMPORTED_MODULE_1__.c)(el, resolve));
...
const openURL = /*#__PURE__*/function () {
  var _ref = (0,C_Users_bmgpc_Documents_titulacion_AppTitulacion_gestionar_gastos_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (url, ev, direction, animation) {
